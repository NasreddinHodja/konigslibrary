...
{#if update}
  ...
  >
    ...
    <button
      class="ml-auto flex items-center gap-1 border-2 border-white px-2 py-1 font-mono text-xs font-bold tracking-widest text-white hover:bg-white hover:text-black"
      onclick={download}
    >
      <Download size={12} />
      DOWNLOAD
